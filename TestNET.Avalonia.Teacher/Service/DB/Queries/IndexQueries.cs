...
namespace TestNET.Avalonia.Teacher.Service.DB.Queries;
...
internal class IndexQueries(string dbPath)
{
    private static string GetEmbeddedResource(string resourceName)
    {
        ...
        using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream($"TestNET.Avalonia.Teacher.Service.DB.Queries.Index.{resourceName}"))
        {
